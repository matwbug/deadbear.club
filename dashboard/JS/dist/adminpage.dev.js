...
$(function () {
  ...
  $(document).on('click', '.remove-an', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'tab-removerAnuncio',
        'id': id
      }
    }).done(function (data) {
      $('#fountainG').css('display', 'none');
  ...
  $(document).on('click', '[js="manage-feedbacks"]', function () {
    if (!$(this).hasClass('active')) {
      ...
      $.ajax({
        ...
        data: {
          'token': sessionStorage.getItem('token'),
          'type-action': 'manageFeedbacks'
        }
      }).done(function (data) {
        data = JSON.parse(data); //$('.tabopened').remove()
  ...
  $(document).on('click', '[js="aprovar-feedback"]', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'confirm-aprovarFeedback',
        'id': id
      }
    }).done(function (data) {
      data = JSON.parse(data);
  ...
  $(document).on('click', '.remove-feedback', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'tab-excluirFeedback',
        'id': id
      }
    }).done(function (data) {
      data = JSON.parse(data);
  ...
  $(document).on('click', '[js="confirmExcluirFeedback"]', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'confirmExcluirFeedback',
        'id': id
      }
    }).done(function (data) {
      data = JSON.parse(data);
  ...
  $(document).on('click', '.tab-edit-cat', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'tab-editarCategoria',
        'id': id
      }
    }).done(function (data) {
      data = JSON.parse(data);
  ...
  $(document).on('click', '.confirm-editCategoria', function () {
    ...
    var img = $(this).parent().find("img[data-name]").prop('src');
    img = img.split('/')[7]; //corrigir isso dps do deploy
  ...
  $(document).on('click', '.tab-remove-cat', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'tab-excluirCategoria',
        'id': id
      }
    }).done(function (data) {
      data = JSON.parse(data);
  ...
  $(document).on('keyup', '[name="searchtransation"]', function () {
    ...
    $.ajax({
      ...
      data: {
        'token': sessionStorage.getItem('token'),
        'type-action': 'manageTransacoes',
        'searchtransation': search,
        'type': 'search'
      }
    }).done(function (data) {
      data = JSON.parse(data);
